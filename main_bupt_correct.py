...
parser.add_argument("--adj_dropout", type=float, default=0.1, help="mixed dropout for adj")
...
parser.add_argument('--att_loss_weight', type=float, default=0.01, help="attention loss weight")
parser.add_argument('--attention_weight', type=float, default=0.5, help='External Attention coefficient.')
parser.add_argument('--feature_weight', type=float, default=0.6, help='Feature adjust coefficient about attention.')
...
if args.dataset == 'Sichuan':
    ...
    dataset, _ = load_graphs("./data/BUPT_tele_correct.bin")
