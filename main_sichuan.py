...
parser.add_argument("--adj_dropout", type=float, default=0.4, help="mixed dropout for adj")
...
parser.add_argument('--attention_weight', type=float, default=0.1, help='External Attention coefficient.')
parser.add_argument('--feature_weight', type=float, default=0.1, help='Feature adjust coefficient about attention.')
